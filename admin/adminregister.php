...
if(isset($_POST['submit'])){
   ...
   if (empty($name) || empty($email) || empty($_POST['password']) || empty($_POST['cpassword']) || empty($phone)) {
      ...
      if(mysqli_num_rows($select) > 0){
         ...
         if($pass != $cpass){
            ...
            if($insert){
               echo "<script>alert('Registered successfully!'); window.location.href='admin_login.php';</script>";
               exit;
            } else {
