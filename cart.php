...
<div id="cart">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td class="con-shop .cart-button-action" colspan="3"><a href="products.php" class="btn btn-success"><i class="fas fa-cart-plus"></i>&nbsp;&nbsp;Continue Shopping</a></td>
          <td colspan="2"><b>Grand Total</b></td>
          <td><b ><i class="fa-solid fa-rupee-sign"></i>&nbsp;&nbsp;<?= number_format($grand_total,2); ?></b></td>
          <td class="check-out .cart-button-action"><a href="checkout.php" class="btn btn-info <?= ($grand_total > 1) ? '' : 'disabled'; ?>"><i class="far fa-credit-card"></i>&nbsp;&nbsp;Checkout</a></td>
        </tr>
